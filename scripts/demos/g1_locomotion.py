...
"""
This script demonstrates an interactive demo with the G1 rough terrain environment.
...
parser = argparse.ArgumentParser(
    description="This script demonstrates an interactive demo with the G1 rough terrain environment."
)
...
class G1RoughDemo:
    """This class provides an interactive demo for the G1 rough terrain environment.
    It loads a pre-trained checkpoint for the Isaac-Velocity-Rough-G1-v0 task, trained with RSL RL
